...
/** Matrix of size: 21 x 37 (row major format)
 * 
...
real_t objValueIn[ 61 ];

/** Row vector of size: 575 */
real_t objValueOut[ 575 ];
...
/** Matrix of size: 18 x 17 (row major format) */
real_t QN2[ 306 ];

/** Column vector of size: 787 */
real_t conAuxVar[ 787 ];

/** Row vector of size: 61 */
real_t conValueIn[ 61 ];

/** Row vector of size: 125 */
real_t conValueOut[ 125 ];
...
/** Matrix of size: 3780 x 6 (row major format) */
real_t E[ 22680 ];
 ...
 *
 *  \param rk_eta Working array of size 61 to pass the input values and return the results.
